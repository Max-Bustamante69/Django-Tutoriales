...
SECRET_KEY = 'django-insecure-)a^fv&&vv2#9uva5h4c3lw_p97^-hqycw%#k0n6btag^lhbb2b'
...
if not os.path.exists(os.path.join(MEDIA_ROOT, 'uploaded_images')):
    os.makedirs(os.path.join(MEDIA_ROOT, 'uploaded_images'), exist_ok=True)
